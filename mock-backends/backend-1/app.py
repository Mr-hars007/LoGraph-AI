...
app = FastAPI(title="Microservice Frontend (MS FE)")
...
def get_home_page():
    ...
    <html>
    <head>
        <title>MS FE - Microservice Frontend Page</title>
        ...
        <div class="max-w-md w-full bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-2xl space-y-6">
            <div class="flex items-center justify-between border-b border-slate-800 pb-4">
                <div class="flex items-center space-x-3">
                    <div class="bg-indigo-600 p-2.5 rounded text-white font-bold">FE</div>
                    <div>
                        <h1 class="text-lg font-bold">Microservice FE</h1>
                        <p class="text-xs text-slate-400">Client Facing Portal</p>
                    </div>
                </div>
            ...
            <div class="text-xs text-slate-500 text-center border-t border-slate-800 pt-4">
                System is monitored by Logoph Guard & Control Agent (LGCA-1)
            </div>
        </div>
    </body>
    </html>
